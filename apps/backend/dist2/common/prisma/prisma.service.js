...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            error_1 = _a.sent();
                            retries--;
                            this.logger.warn("Database connection failed, ".concat(retries, " retries left"));
                            if (retries === 0)
                                throw error_1;
        ...
        PrismaService_1.prototype.executeTransaction = function (fn) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.$transaction(function (prisma) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                return [2 /*return*/, fn(prisma)];
                            });
                        }); })];
                });
            });
        ...
        PrismaService_1.prototype.cleanDatabase = function () {
            return __awaiter(this, void 0, void 0, function () {
                var tablenames, _i, tablenames_1, tablename, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            if (!(tablename !== '_prisma_migrations')) return [3 /*break*/, 6];
                            _a.label = 3;
                        case 3:
                            _a.trys.push([3, 5, , 6]);
