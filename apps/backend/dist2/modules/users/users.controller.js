...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getNotifications = function (userId, page, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.getNotifications(userId, page, limit)];
                });
            });
        };
        UsersController_1.prototype.markNotificationRead = function (userId, notificationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.markNotificationRead(userId, notificationId)];
                });
            });
        };
    ...
    (function () {
        ...
        _getNotifications_decorators = [(0, common_1.Get)('me/notifications'), (0, swagger_1.ApiOperation)({ summary: 'Get user notifications' })];
        _markNotificationRead_decorators = [(0, common_1.Patch)('me/notifications/:id/read'), (0, swagger_1.ApiOperation)({ summary: 'Mark notification as read' })];
