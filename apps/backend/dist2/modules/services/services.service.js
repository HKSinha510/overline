...
var ServicesService = function () {
    ...
    var ServicesService = _classThis = /** @class */ (function () {
        ...
        ServicesService_1.prototype.create = function (shopId, dto, tenantId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            shop = _a.sent();
                            if (!shop) {
                                throw new common_1.ForbiddenException('Not authorized to manage this shop');
                            }
        ...
        ServicesService_1.prototype.findByShop = function (shopId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        ServicesService_1.prototype.findById = function (serviceId) {
            return __awaiter(this, void 0, void 0, function () {
                var service;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ServicesService_1.prototype.update = function (serviceId, dto, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var service;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (service.shop.tenantId !== tenantId) {
                                throw new common_1.ForbiddenException('Not authorized to manage this service');
                            }
        ...
        ServicesService_1.prototype.delete = function (serviceId, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var service;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ServicesService_1.prototype.reorder = function (shopId, serviceIds, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var shop;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, Promise.all(serviceIds.map(function (id, index) {
                                    return _this.prisma.service.update({
                                        where: { id: id },
                        ...
                        case 2:
                            // Update sort order for each service
                            _a.sent();
                            return [2 /*return*/, this.findByShop(shopId)];
                    }
                });
            });
        };
