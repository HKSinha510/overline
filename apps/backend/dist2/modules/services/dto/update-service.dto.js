...
var UpdateServiceDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateServiceDto() {
                ...
                this.isActive = (__runInitializers(this, _price_extraInitializers), __runInitializers(this, _isActive_initializers, void 0));
        ...
        (function () {
            ...
            _name_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Service name' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(100)];
            ...
            _durationMinutes_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Duration in minutes' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(5)];
            _price_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Price' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0)];
            _isActive_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Is service active' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)()];
            _sortOrder_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Sort order' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)()];
