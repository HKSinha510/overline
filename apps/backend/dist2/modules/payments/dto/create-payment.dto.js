...
var CreatePaymentDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreatePaymentDto() {
                ...
                this.provider = (__runInitializers(this, _bookingId_extraInitializers), __runInitializers(this, _provider_initializers, void 0));
        ...
        (function () {
            ...
            _bookingId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Booking ID to pay for' }), (0, class_validator_1.IsString)()];
            _provider_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: client_1.PaymentProvider, description: 'Payment provider' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.PaymentProvider)];
