...
var ReviewsService = function () {
    ...
    var ReviewsService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.updateShopRating(booking.shopId)];
                        case 3:
                            // Update shop's average rating (could also use a trigger)
                            _a.sent();
         ...
         */
        ReviewsService_1.prototype.findByShop = function (shopId_1) {
            return __awaiter(this, arguments, void 0, function (shopId, page, limit) {
                var skip, _a, reviews, total, stats;
                        ...
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    this.prisma.review.findMany({
                                        where: { shopId: shopId, isPublic: true },
                                        include: {
                                            user: {
                                                select: { id: true, name: true, avatarUrl: true },
                                            },
                                    ...
                                    this.prisma.review.count({ where: { shopId: shopId, isPublic: true } }),
                                ])];
                        case 1:
                            _a = _b.sent(), reviews = _a[0], total = _a[1];
                            return [4 /*yield*/, this.getShopRatingStats(shopId)];
                        case 2:
                            stats = _b.sent();
                            return [2 /*return*/, {
                                    data: reviews,
         ...
         */
        ReviewsService_1.prototype.getShopRatingStats = function (shopId) {
            return __awaiter(this, void 0, void 0, function () {
                var reviews, distribution, sum;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         */
        ReviewsService_1.prototype.replyToReview = function (reviewId, dto, userId, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var review;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (review.shop.tenantId !== tenantId) {
                                throw new common_1.ForbiddenException('You can only reply to reviews for your shop');
                            }
                            return [2 /*return*/, this.prisma.review.update({
                                    where: { id: reviewId },
                                    data: {
                                        reply: dto.reply,
                                        repliedAt: new Date(),
         ...
         * Get user's reviews
         */
        ReviewsService_1.prototype.findByUser = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        ReviewsService_1.prototype.updateShopRating = function (shopId) {
            return __awaiter(this, void 0, void 0, function () {
                var stats;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getShopRatingStats(shopId)];
                        case 1:
                            stats = _a.sent();
